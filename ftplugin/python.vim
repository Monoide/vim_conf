...
" Pyflakes in QuickFixWindow
nnoremap <buffer> <leader>fl :cexpr system('pyflakes ' . expand('%')) <CR> :cope <CR>
" Pep8 checker
nnoremap <buffer> <leader>p8 :cexpr system('pep8 -v ' . expand('%')) <CR> :cope <CR>
